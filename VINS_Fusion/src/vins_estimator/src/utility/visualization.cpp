...
ros::Publisher pub_camera_poseStamped; //新增话题
...
void pubCameraPose(const Estimator &estimator, const std_msgs::Header &header)
{
    ...
    if (estimator.solver_flag == Estimator::SolverFlag::NON_LINEAR)
    {
        ...
        //新增的话题 pub_camera_poseStamped
        geometry_msgs::PoseStamped poseStamped;
        poseStamped.pose.orientation.w = odometry.pose.pose.orientation.w;
        poseStamped.pose.orientation.w = odometry.pose.pose.orientation.w;
        poseStamped.pose.orientation.x = odometry.pose.pose.orientation.x;
        poseStamped.pose.orientation.y = odometry.pose.pose.orientation.y;
...
void pubTF(const Estimator &estimator, const std_msgs::Header &header)
{
    ...
    correct_t = estimator.Ps[WINDOW_SIZE]; //body-->worl的平移和旋转
