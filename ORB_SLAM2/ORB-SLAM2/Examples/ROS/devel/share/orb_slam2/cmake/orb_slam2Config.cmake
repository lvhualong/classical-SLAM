...
if("TRUE" STREQUAL "TRUE")
  set(orb_slam2_SOURCE_PREFIX /home/ubuntu/coding/classical-SLAM/ORB_SLAM2/ORB-SLAM2/Examples/ROS/src)
  set(orb_slam2_DEVEL_PREFIX /home/ubuntu/coding/classical-SLAM/ORB_SLAM2/ORB-SLAM2/Examples/ROS/devel)
  ...
  set(orb_slam2_INSTALL_PREFIX /home/ubuntu/coding/classical-SLAM/ORB_SLAM2/ORB-SLAM2/Examples/ROS/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'hualong <hualong@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'orb_slam2' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'orb_slam2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/coding/classical-SLAM/ORB_SLAM2/ORB-SLAM2/Examples/ROS/src/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ubuntu/coding/classical-SLAM/ORB_SLAM2/ORB-SLAM2/Examples/ROS/devel/lib;/home/ubuntu/coding/MYNT-SDK/MYNT-EYE-D-SDK_NEW/wrappers/ros/devel/lib;/home/ubuntu/software/perception_pcl1.8-ros/pcl_ros_ws/devel/lib;/home/ubuntu/coding/MYNT-SDK/MYNT-EYE-D-SDK/wrappers/ros/devel/lib;/home/ubuntu/coding/px4-simulation/avoidance_ros_ws/devel/lib;/home/ubuntu/coding/px4-simulation/gazebo_ros_ws/devel/lib;/opt/ros/kinetic/lib)
